...
import { TranscriptConsequenceSummary, VariantAnnotationSummary } from 'genome-nexus-ts-api-client';
...
export default class BasicInfo extends React.Component<IBasicInfoProps> {
        ...
        if (this.props.annotation) {
            ...
            return (
                <div className={'basic-info-container'}>
                    <span className={basicInfoStyle['basic-info-pills']}>
                        {basicInfoList}
                        {this.jsonButton()}
                        {haveTranscriptTable &&
                    ...
                    <TranscriptSummaryTable
                        ...
                        allValidTranscripts={this.props.allValidTranscripts ? this.props.allValidTranscripts : []}
                        onTranscriptSelect={this.props.onTranscriptSelect}
                    />
                    {this.showAllTranscripts && haveTranscriptTable && (
                        <div className={basicInfoStyle['transcript-table-source']}>
    ...
    public getDataFromTranscriptConsequenceSummary(
        ...
        const parsedData: IBasicInfoData[] = [];
        // gene
        parsedData.push({
                ...
                >
                    <span
                        className={classNames(
                            basicInfoStyle[`${category}`],
                            basicInfoStyle[`data-pills`]
                        )}
                    >
                        <a
                            href={oncokbUrl}
