...
import functionalGroupsStyle from '../FunctionalGroups';
import functionalImpactColor from '../FunctionalImpactTooltip.module.scss';
...
> {
    ...
    private static mutationAssessorTooltipTable() {
        return (
            <div>
                <Table table-border-top={true} striped={true} bordered={true} hover={true} size="sm">
                    <thead>
                        <tr>
                            <th>Legend</th>
                            <th>
