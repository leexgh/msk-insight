...
import { MutationAssessor as MutationAssessorData, VariantAnnotation} from 'genome-nexus-ts-api-client';
import { observer } from 'mobx-react';
import * as React from 'react';
import { SHOW_MUTATION_ASSESSOR } from 'src/util/Constants';
